...
--  =========
--  
--      * Handles both 'application/x-www-form-urlencoded' and 
--        'multipart/form-data' content-types
--      * Handles file uploads
--      * Handles multi-valued fields
--      * Optional hooks for XML handler to handle 'text/xml'
--        content-types (eg xmlrpc etc)
...
--          c.options.xxxx = ....
--          c.parse()
--          for k,v in c.fields do print(k,v) end
--
